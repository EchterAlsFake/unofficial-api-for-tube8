...
from tube8_api.api import create_parser, run_main
...
class TestCLI(unittest.IsolatedAsyncioTestCase):
    ...
    def test_parser_custom_args(self):
        ...
        args = parser.parse_args([
            "--download", "https://tube8.com/video/123/test",
            "--output", "/tmp/out",
            "--quality", "worst",
            "--no-title", "True"
        ])
        self.assertEqual(args.download, "https://tube8.com/video/123/test")
        self.assertEqual(args.output, "/tmp/out")
    ...
    async def test_run_main_download(self):
        ...
        with patch("tube8_api.api.Client", return_value=mock_client):
            await run_main(["--download", "https://tube8.com/video/123/test", "--output", "/tmp/out"])

        mock_client.get_video.assert_awaited_once_with("https://tube8.com/video/123/test", load_html=True)
    ...
    async def test_real_download(self):
        ...
        url = "https://www.tube8.com/porn-video/81330021/"
